...
Peingは2025年８月をもってサービス提供を終了することとなりました。
本ソフトは、終了までの間これまで通り利用できるとともに、終了前にデータを蓄積していた場合には、そのデータのビューアーとして動作し続けます。
ただし、最新データの取得のほか、投稿済みの質問・届いた質問の表示機能についてはデータの保存をせずリアルタイム表示する仕様のため、サービス終了後は閲覧できなくなることにご注意ください。


以下、このファイル上の説明は、サービス提供期間中のものをそのまま残してあります。


このサービスでは、ウェブ上で質問箱を開設したユーザに対して、匿名で質問を送ることができます。
質問を受け取った開設者は、公開の場で回答します。
詳細については、過去のネットニュースなどを確認してください。
